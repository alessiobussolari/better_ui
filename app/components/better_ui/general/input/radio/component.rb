    ...
    module Input
      module Radio
        class Component < ViewComponent::Base
          ...
          RADIO_BASE_CLASSES = 'appearance-none border-2 focus:outline-none transition-colors duration-200 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50'.freeze
