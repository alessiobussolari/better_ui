module BetterUi
  module General
    class DividerComponentPreview < Lookbook::Preview
      # @!group Esempi Base
      ...
      # @param theme select { choices: [default, white, red, rose, orange, green, blue, yellow, violet, gray] } "Tema del divisore"
